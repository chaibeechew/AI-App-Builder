...
function buildPrompt(userIdea,patterns,{voiceTranscript="",referenceImages=[],language="en",industry="technology",terminology=[],createDemoVideo=false,themeMode="auto",themePreset="auto",primaryColor="",accentColor="",backgroundColor="",styleRequest="",wallpaperMode="random",wallpaperPreset=""}={}) {
