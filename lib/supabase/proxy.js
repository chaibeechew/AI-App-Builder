...
const PUBLIC_SERVER_ENDPOINTS = new Set(["/api/whatsapp/webhook","/api/auth/verification/request","/api/auth/verification/verify","/api/auth/session"]);
...
export async function updateSession(request) {
  ...
  const laneriqSession=await validateLaneriqSessionToken(laneriqToken);
