...
const PUBLIC_SERVER_WEBHOOKS = new Set([
  "/api/whatsapp/webhook",
  "/api/auth/whatsapp-otp-hook",
]);
...
export async function updateSession(request) {
  ...
  // Meta and Supabase Auth must reach only these exact server-to-server webhook endpoints without a user session.
  // Each route performs its own cryptographic signature or verify-token checks before doing any work.
