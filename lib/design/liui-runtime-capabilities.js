...
const contexts = [
  ...
  { pageId: 15, pattern: /^\/workflows\/[^/?]+\/?(?:\?.*)?$/, surface: "workflow", phase: "Edit Workflow", name: "Workflow Editor", primaryAction: "Edit, test and activate workflow logic", primaryNav: "Projects" },
...
export function resolveLiuiRouteContext(pathname = "") {
