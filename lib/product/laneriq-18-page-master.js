export const LANERIQ_18_PAGE_SPEC_VERSION = "2026.09-v1";
...
const pages = [
  {
    ...
    data: ["session", "style preference", "reference asset metadata"],
    risk: "low",
    humanApproval: false,
  ...
  },
  {
    ...
    route: "/?flow=create-project",
    purpose: "Turn the raw idea into an explicit project brief and controlled build plan.",
    primaryAction: "Generate Project",
    ...
    data: ["project brief", "template intelligence", "project memory seed"],
    risk: "medium",
    humanApproval: true,
    evidence: "code-ci-before-live-provider",
  },
  {
    id: 3,
    slug: "build-progress",
    name: "Build Progress",
    route: "/?flow=build-progress",
    purpose: "Expose truthful generation progress while LANERIQ builds, validates and persists the project.",
    primaryAction: "Continue in background / Open result",
    ...
    data: ["generation request", "idempotency key", "build progress", "generated project id"],
    risk: "medium",
    humanApproval: false,
    evidence: "runtime-progress-must-not-fake-completion",
  },
  {
    id: 4,
    slug: "preview",
    name: "Preview",
    route: "/preview/[id]",
    purpose: "Let the user inspect the generated product before release actions are allowed.",
    primaryAction: "Approve preview or return to edit",
    ...
    data: ["project", "current version", "preview artifact"],
    risk: "low",
    humanApproval: true,
  ...
  },
  {
    ...
    name: "Launch",
    route: "/release/[id]",
    purpose: "Choose release targets and prepare release checks without implying store or provider LIVE status prematurely.",
    ...
    data: ["release target", "readiness checks", "store preparation metadata"],
    risk: "high",
    humanApproval: true,
    evidence: "release-ready-is-not-store-live",
  },
  {
    id: 6,
    slug: "manage-grow",
    name: "Manage & Grow",
    route: "/app-dashboard",
    purpose: "Operate released projects, inspect health and growth, and return to editing safely.",
    primaryAction: "Open project workspace",
    userActions: ["inspect apps", "open analytics", "open editor", "review AI suggestions"],
    aiActions: ["summarize meaningful changes", "recommend optimizations", "wait for approval before live changes"],
    data: ["projects", "analytics aggregates", "release status"],
    risk: "medium",
    humanApproval: true,
    evidence: "real-data-only-for-live-metrics",
  },
  {
    id: 7,
    slug: "my-projects",
    name: "My Projects / Creations",
    route: "/my-apps",
    purpose: "Give the user one authoritative place to resume, inspect or create projects.",
    primaryAction: "Open / Continue / New Project",
    ...
    data: ["owned projects", "versions", "build status"],
    risk: "low",
    humanApproval: false,
    evidence: "supabase-owner-scoped",
  },
  {
    id: 8,
    slug: "templates",
    name: "Templates",
    route: "/templates",
    purpose: "Expose LANERIQ's industry templates and popular design references as generation intelligence, not clones.",
    primaryAction: "Open template / Build with AI",
    ...
    data: ["template catalog", "industry patterns", "UI patterns"],
    risk: "low",
    humanApproval: false,
    evidence: "template-intelligence",
  },
  {
    id: 9,
    slug: "ai-assistant",
    name: "AI Assistant",
    route: "/soolen-ai",
    purpose: "Provide a universal AI command layer across creation and project operations.",
    primaryAction: "Execute or prepare an AI command",
    ...
    data: ["project context", "project memory", "version history"],
    risk: "medium",
    humanApproval: true,
    evidence: "command-layer",
  },
  {
    id: 10,
    slug: "automation",
    name: "Automation",
    route: "/workflows",
    purpose: "Create and operate automations with explicit triggers, conditions, actions and safe execution boundaries.",
    ...
    data: ["app_workflows", "workflow_runs"],
    risk: "high",
    humanApproval: true,
    evidence: "workflow-runtime",
  },
  {
    id: 11,
    ...
    route: "/analytics",
    purpose: "Show privacy-safe, owner-scoped product analytics and actionable growth insights.",
    primaryAction: "Inspect insight / Open project",
    userActions: ["change range", "inspect app", "export report"],
    aiActions: ["summarize trends", "separate observed data from prediction", "avoid invented revenue/users"],
    data: ["analytics_events", "owner-scoped aggregates"],
    risk: "medium",
    humanApproval: false,
    evidence: "real-data-required",
  },
  {
    id: 12,
    slug: "more-settings",
    name: "More & Settings",
    route: "/studio",
    purpose: "Centralize account, AI engine, data, privacy, help and advanced product controls.",
    primaryAction: "Open selected setting",
    ...
    data: ["account settings", "provider readiness metadata", "brand kit", "privacy preferences"],
    risk: "high",
    humanApproval: true,
    evidence: "settings-permission-boundary",
  },
  {
    id: 13,
    slug: "project-ai-editor",
    name: "Project Detail / AI Editor",
    route: "/generated/[id]",
    purpose: "Act as the daily project workspace for previewing, editing, versioning, testing and publishing.",
    primaryAction: "Apply AI change safely",
    ...
    data: ["apps", "app_versions", "project_memory", "generated specification"],
    risk: "high",
    humanApproval: true,
    evidence: "versioned-editing",
  },
  {
    id: 14,
    ...
    route: "/templates/[id]",
    purpose: "Explain what a template contains and adapt it to the user's business before generation.",
    primaryAction: "Use Template / Build with AI",
    ...
    data: ["template", "industry intelligence", "user adaptation brief"],
    risk: "medium",
    humanApproval: true,
    evidence: "template-adaptation",
  },
  {
    id: 15,
    ...
    route: "/workflows/[id]",
    purpose: "Visually edit triggers, conditions, actions and AI-assisted workflow logic.",
    primaryAction: "Save & Activate",
    userActions: ["add node", "connect node", "test", "save", "activate", "inspect run history"],
    aiActions: ["generate workflow from language", "validate graph", "simulate safely", "require confirmation for risky integrations"],
    data: ["app_workflows", "workflow_runs", "integration references"],
    risk: "high",
    humanApproval: true,
    evidence: "workflow-editor-runtime",
  },
  {
    id: 16,
    slug: "database-manager",
    name: "Database Manager",
    route: "/operations/[id]?tab=data",
    purpose: "Manage project data models, records and relationships without exposing infrastructure secrets.",
    primaryAction: "Apply safe schema/data change",
    ...
    data: ["app_backend_models", "project data", "RLS metadata"],
    risk: "critical",
    humanApproval: true,
    evidence: "database-ownership-security",
  },
  {
    id: 17,
    slug: "ai-testing-self-heal",
    name: "AI Testing & Self-Heal",
    route: "/operations/[id]?tab=quality",
    purpose: "Run product, security, accessibility, performance and LIUI tests; self-heal bounded issues and retest.",
    primaryAction: "Run Tests / Apply Safe Fixes",
    ...
    data: ["test evidence", "quality judge", "release readiness", "version history"],
    risk: "critical",
    humanApproval: true,
    evidence: "code-ci-browser-provider-device-store-separated",
  },
  {
    id: 18,
    slug: "publish-deployment-center",
    name: "Publish & Deployment Center",
    route: "/publish/[id]",
    purpose: "Prepare and execute controlled Web/iOS/Android/Desktop release operations after quality gates pass.",
    primaryAction: "Publish / Deploy",
    ...
    data: ["publish_requests", "store_listings", "deployment evidence", "release version"],
    risk: "critical",
    humanApproval: true,
    evidence: "production-exact-sha-plus-runtime-evidence",
  },
];
