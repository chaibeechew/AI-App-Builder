export const LANERIQ_18_PAGE_SPEC_VERSION = "2026.09-v4-liui-2026.2";
...
const pages = [
  ...
  {
    id:2, slug:"create-project", name:"Create Project / Plan", route:"/create", routeFile:"app/create/page.js",
  ...
  {
    id:3, slug:"build-progress", name:"Build Progress", route:"/create?flow=build-progress", routeFile:"app/create/page.js",
  ...
  },
  {
    ...
    data:["owned project","anonymous analytics aggregates","release status"], risk:"medium", humanApproval:true, evidence:"real-data-only-for-live-metrics",
  },
  {
  ...
  },
  {
    ...
    purpose:"Show anonymous aggregate, owner-scoped project analytics and actionable growth insights without visitor profiling.", primaryAction:"Inspect insight / Open project",
    userActions:["inspect project analytics","review aggregate activity","return to project"],
    aiActions:["summarize aggregate trends","separate observed data from prediction","avoid invented revenue/users","never reconstruct individual journeys"],
    data:["analytics_daily_aggregates","anonymous aggregate counts"], risk:"medium", humanApproval:false, evidence:"real-data-required",
  },
  {
...
export const LANERIQ_18_PAGE_AI_RULES = Object.freeze({
  ...
  anonymousAggregateAnalyticsOnly:true,
  neverBuildVisitorBehaviorProfiles:true,
...
export const LANERIQ_18_PAGE_DESIGN_RULES = Object.freeze({
  ...
  designAuthority:"LIUI-2026.2",
  legacyDesignCompatibility:false,
  intentFirst:true,
