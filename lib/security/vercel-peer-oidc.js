...
export const LANERIQ_MALWARE_PROJECT_ID = "prj_FZIKN1bbUKP9wKaKgz9594Mb2mqS";
export const LANERIQ_MALWARE_PROJECT_NAME = "laneriq-malware-defense";
...
export async function verifyMalwareDefenseProductionPeer(request) {
  return verifyVercelPeerRequest(request, {
    projectId: LANERIQ_MALWARE_PROJECT_ID,
    projectName: LANERIQ_MALWARE_PROJECT_NAME,
