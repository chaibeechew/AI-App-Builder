...
export const SMS_OTP_POLICY = Object.freeze({
  ...SHARED_OTP_POLICY,
  codeLength: 6,
  maxPhoneLength: 16,
});
...
export function normalizePhoneNumber(value) {
  ...
  if (!/^\+[1-9]\d{7,14}$/.test(phone) || phone.length > SMS_OTP_POLICY.maxPhoneLength) {
...
export function normalizeSmsOtp(value) {
  return normalizeNumericOtp(value, SMS_OTP_POLICY, "SMS");
}

export function otpPolicyForMethod(method) {
  return method === "sms" ? SMS_OTP_POLICY : EMAIL_OTP_POLICY;
}
