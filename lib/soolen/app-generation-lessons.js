export const SOOLEN_APP_GENERATION_LESSONS_VERSION = "2026-09-02.v1";

export const SOOLEN_APP_GENERATION_LESSONS = Object.freeze({
  industryVisualSemantics:[
    "Detect the industry and service context before choosing imagery, hero composition or visual assets.",
  ...
  imageOriginality:[
    ...
    "Every visual asset description should be specific enough that a later image generator can produce a distinct scene."
  ],
  typographyAndVisualBalance:[
    ...
    "A hero should normally balance meaningful visual media and concise text; text-only first screens are not acceptable for image-appropriate consumer or service products.",
...
export const SOOLEN_FAST_BUILD_SEQUENCE = Object.freeze([
  ...
  "choose-unique-industry-visual-direction",
...
Do not let giant text cover the industry visual. Mobile hero titles should normally stay around 28-40px and major section headings around 22-30px. Keep imagery clearly visible with enough contrast protection for text, rather than hiding the image under opaque panels.

FAST BUILD
Use one-pass generation whenever possible: infer industry, audience, visual direction, core pages, data, actions and distribution from the idea, then generate the smallest complete premium product. Reuse validated patterns and quality contracts to save time, but never copy a customer's unique brand or exact image composition. Ask follow-up questions only when truly necessary.
