...
export function consumeAiCredits(userId,{amount,requestId,description,metadata={}}){
  if(isNoCreditsLaunchMode()||zeroSpendComputeMode())return Promise.resolve({charged:false,balance:null,launchModeBypass:isNoCreditsLaunchMode(),zeroSpendComputeBypass:zeroSpendComputeMode(),requestId});
...
export function refundAiCredits(userId,{amount,requestId,description,metadata={}}){
  if(isNoCreditsLaunchMode()||zeroSpendComputeMode())return Promise.resolve({refunded:false,balance:null,launchModeBypass:isNoCreditsLaunchMode(),zeroSpendComputeBypass:zeroSpendComputeMode(),requestId});
