...
export function consumeAiCredits(userId,{amount,requestId,description,metadata={}}){return call("server_consume_ai_credits",{p_user_id:userId,p_amount:amount,p_request_id:requestId,p_description:description,p_metadata:metadata});}
export function refundAiCredits(userId,{amount,requestId,description,metadata={}}){return call("server_refund_ai_credits",{p_user_id:userId,p_request_id:requestId,p_amount:amount,p_description:description,p_metadata:metadata});}
