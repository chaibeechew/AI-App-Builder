...
export function buildStoreReadiness({specification={},listing=null,assets=[],inferredAnswers={},customerDeclarations={}}={}){
  ...
  return {checks,blocking,preparable,customerRequired,externalRequired,permissionRequirements,assets:assetState,customerDeclarations:declarations,readinessScore,readyForCustomerReview:customerRequired.length===0&&preparable.length===0,readyForOfficialSubmission:false};
}
