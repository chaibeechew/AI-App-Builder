export const PRO_MODE = Object.freeze({
  ...
  pricingTerms: {
    ...
    fullAccessUsd: 199,
    fullAccessDays: 365,
    fullAccessAutoRenew: false,
    priceReviewIntervalYears: 3,
    priceIncreaseOptional: true,
  },
  gameCreator: {
    enabled: true,
    accessTier: "professional_or_full",
    customerPolicy: "Fair Price · Fair Use · Creator First",
    normalGenuineUseIncluded: true,
    noSurprisePerClickCharges: true,
    professionalCooldownMinutes: [30, 60, 120, 240, 480],
    professionalMaximumCooldownHours: 8,
    cooldownAffectsOnlyNewGameStarts: true,
  ...
  categories: [
    {
      ...
      description: "Turn a game idea into a playable 2D mobile-game Vertical Slice with creator-first Fair Price · Fair Use access.",
    ...
    },
    {
      id: "logic",
      name: "Pro Logic",
      description: "Control customer data, forms, CRM, automations, LANERIQ-managed communications and payments without exposing infrastructure.",
      tools: ["Customer Data", "Automations", "LANERIQ Services", "Payments & Offers", "Project Memory"]
    },
    {
      id: "release",
      name: "Pro Release",
  ...
  return [
    {
      name: "Pro Game Creator",
      items: [
        { name: "Game Builder", href: "/game-builder", note: "Create a playable 2D Vertical Slice for iOS + Android targets under creator-first Fair Price · Fair Use." },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "LANERIQ Services", href: `/integrations/${appId}`, note: "Manage Email, WhatsApp, Calendar, Maps and other LANERIQ-managed services without external linking in the normal workflow." },
    ...
    },
    {
      name: "Pro Release",
      items: [
        { name: "AI Health Check", href: `/operations/${appId}`, note: "Inspect project health, automation failures and managed-service readiness." },
        ...
        { name: "Publishing Center", href: `/release/${appId}`, note: "Review Website, PWA, mobile and release readiness while LANERIQ manages deployment infrastructure." }
      ]
    }
  ];
}
