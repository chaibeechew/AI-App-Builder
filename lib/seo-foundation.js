...
export const SEO_PAGES = Object.freeze({
  "ai-app-game-website-builder": {
    ...
    title: "AI App, Game & Website Builder — Build with AI | LANERIQ AI",
    description: "Create apps, playable games and responsive websites from one idea with LANERIQ AI. Plan, build, test and preview from one AI creation workspace.",
    eyebrow: "APPS • GAMES • WEB",
    heading: "One AI Builder for Apps, Games and Websites",
    intro: "LANERIQ AI turns a natural-language idea into a structured product plan and then routes it into the right creation workflow—app, game or website—without forcing every project into the same template.",
    ...
    faq: [
      ["Can LANERIQ AI create all three product types?", "Yes. The platform has separate app, game and website creation paths while sharing planning, design, testing and preview foundations."],
  ...
  "ai-app-builder": {
    path: "/ai-app-builder",
    primaryKeyword: "AI app builder",
    title: "AI App Builder — Create Apps with AI | LANERIQ AI",
    description: "Build mobile-first apps from natural language with LANERIQ AI. Generate pages, data, workflows, design and a testable preview with AI-assisted self-check and repair.",
    eyebrow: "AI APP BUILDER",
    heading: "Turn One Idea into a Working App Foundation",
    intro: "Describe the people, workflow and outcome you need. LANERIQ AI plans the product structure, generates the experience and checks the result before presenting a preview.",
  ...
  "ai-game-builder": {
    ...
    title: "AI Game Builder — Create Playable Games with AI | LANERIQ AI",
    description: "Create playable mobile game foundations with AI. LANERIQ AI supports 2D and 3D runtime paths, touch controls, game loops, progression, save systems and automated playtesting.",
    eyebrow: "AI GAME BUILDER",
    heading: "Describe a Game. Build a Playable Foundation.",
    intro: "LANERIQ AI understands game genre, interaction scale, world, progression and runtime needs, then routes the idea to a specialist game creation path instead of treating games like ordinary websites.",
  ...
  "ai-website-builder": {
    ...
    title: "AI Website Builder — Create Websites with AI | LANERIQ AI",
    description: "Create responsive websites from one idea with LANERIQ AI. Generate structure, visual direction, calls to action and mobile-friendly pages with AI-assisted testing.",
    eyebrow: "AI WEBSITE BUILDER",
    heading: "Create a Responsive Website from Natural Language",
    intro: "Start with the business, audience and goal—not a blank template. LANERIQ AI turns those requirements into a structured website experience with responsive design and clear conversion paths.",
  ...
  "create-app-with-ai": {
    ...
    title: "Create an App with AI — From Idea to Preview | LANERIQ AI",
    description: "Learn how to create an app with AI using LANERIQ AI: describe your idea, let AI plan the structure, generate the product, self-check it and open a working preview.",
    eyebrow: "CREATE APP WITH AI",
    heading: "How to Create an App with AI from One Idea",
    intro: "The fastest path is to describe the user, problem and result you want. LANERIQ AI handles planning, generation and quality checks while keeping precise edits available when you need them.",
  ...
  "create-game-with-ai": {
    ...
    title: "Create a Game with AI — Idea to Playable Preview | LANERIQ AI",
    description: "Create a game with AI from a natural-language idea. LANERIQ AI plans genre, controls, game loop, progression and runtime before building a playable preview foundation.",
    eyebrow: "CREATE GAME WITH AI",
    heading: "How to Create a Game with AI and Open It to Play",
    intro: "Describe the genre, player action, win condition and progression. LANERIQ AI uses specialist game planning and runtime routing to turn the idea into a testable gameplay foundation.",
    ...
    faq: [
      ["Do I need a game engine?", "The LANERIQ AI workflow provides its own preview runtime paths for supported game types, so the user starts from the idea rather than engine setup."],
  ...
  "mobile-app-builder": {
    ...
    title: "AI Mobile App Builder for iOS & Android | LANERIQ AI",
    description: "Build mobile-first app foundations with AI for iOS and Android targets. LANERIQ AI plans touch UX, safe areas, lifecycle behavior, accessibility and responsive preview workflows.",
    eyebrow: "AI MOBILE APP BUILDER",
    heading: "Build for Mobile First, Then Validate the Real Device",
    intro: "LANERIQ AI treats mobile behavior as a product requirement, not a desktop layout shrunk to fit. Touch targets, safe areas, lifecycle recovery and responsive layouts are part of the readiness model.",
    ...
    faq: [
      ["Does LANERIQ AI produce signed iOS or Android binaries automatically?", "No production claim is made without signed native build evidence. The builder prepares targets and validates what can be verified internally."],
  ...
  "no-code-ai-builder": {
    ...
    primaryKeyword: "no code AI app builder",
    title: "No-Code AI Builder for Apps, Games & Web | LANERIQ AI",
    description: "Create apps, games and websites without starting from code. LANERIQ AI combines natural-language creation, precise editing, data, automation, media and preview workflows.",
    eyebrow: "NO-CODE AI BUILDER",
    heading: "Build with Natural Language Instead of Starting with Code",
    intro: "LANERIQ AI is designed for people who want to describe outcomes, review the result and make precise changes without manually assembling a software stack for every idea.",
...
export function buildSoftwareJsonLd() {
  return {
    ...
    featureList: ["AI app builder", "AI game builder", "AI website builder", "No-code precise editing", "AI self-check and repair", "Mobile-first preview workflows"],
    ...(SEO_SITE_URL ? { url: SEO_SITE_URL } : {}),
  };
}
