...
function hashSecret(){return String(process.env.LANERIQ_COMMUNICATIONS_HASH_SECRET||process.env.LANERIQ_COMMUNICATION_PRIVACY_SECRET||process.env.SUPABASE_SECRET_KEY||process.env.SUPABASE_SERVICE_ROLE_KEY||"").trim();}
...
export function communicationGuardStatus(){return {ready:Boolean(hashSecret()),persistent:true,hashOnly:true,dedicatedPrivacySecret:Boolean(process.env.LANERIQ_COMMUNICATIONS_HASH_SECRET||process.env.LANERIQ_COMMUNICATION_PRIVACY_SECRET)};}
