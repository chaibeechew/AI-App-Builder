...
function createContractAdapter(channel,sender=null){
  ...
  return {
    ...
    async handleWebhook(){return {accepted:false,channel:safeChannel,status:"provider_adapter_required",evidenceLevel:"CODE"};},
    async getDeliveryStatus(){return {channel:safeChannel,status:"unknown",evidenceLevel:"CODE"};},
  };
}
