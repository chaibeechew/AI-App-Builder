...
export function createRuntimeEvidenceSessionV6({worldId="world",route="/game-world-v6",source="browser"}={}){
  return{version:GAME_WORLD_RUNTIME_EVIDENCE_V6.version,sessionId:`rt_${Math.random().toString(36).slice(2,10)}`,worldId:String(worldId),route:String(route),source,startedAt:new Date().toISOString(),browser:{contextCreated:false,api:"unknown",rendererClass:"unknown",webgl2:false,maxTextureSize:0},samples:[],runtime:{residentChunks:0,navPathPoints:0,physicsBodies:0,adaptiveProfile:"unknown"},privacy:{rawUserAgentStored:false,ipStored:false,locationStored:false,persistentFingerprintStored:false},truth:{browserRuntimeVerified:false,hardwareGpuVerified:false,realDeviceFpsVerified:false,realDeviceThermalVerified:false,productionRuntimeVerified:false}};
}
...
export function finalizeRuntimeEvidenceV6(session={}){
  ...
  return{...session,completedAt:new Date().toISOString(),summary,truth:{...session.truth,browserRuntimeVerified:measuredBrowser,realDeviceFpsVerified:measuredBrowser&&sustained,realDeviceThermalVerified:false,productionRuntimeVerified:false},evidenceLevel:measuredBrowser&&sustained?"BROWSER_RUNTIME_MEASURED":measuredBrowser?"BROWSER_CONTEXT_MEASURED":"CODE_ONLY"};
}
