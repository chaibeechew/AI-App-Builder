...
const INTERNAL_AREAS=Object.freeze([
  "ideaUnderstanding","multidimensionalTaxonomy","mobileRuntime","genreSpecificRuntimes","rpgPuzzleAction","advancedGenres","remainingGenres","mobaTraining","aviationKnowledge","airCombat3d","authoritativeMultiplayer","liveTransportContract","multiplayerAdapterAbstraction","platformSystems","world3dSystems","rpgOpenWorldDepth","platformWorkbench","advanced3dGameplaySystems","advanced3dWorkbench","aaaMobileProductionSystems","aaaMobileProductionWorkbench","contentProductionSystems","contentProductionWorkbench","gameStudioIntelligenceSystems","gameStudioIntelligenceWorkbench","autonomousGameDirectorV2","autonomousQaWorkbench","autonomousDevelopmentAgentV3","autonomousDevelopmentWorkbench","selfCheckRecovery"
]);
