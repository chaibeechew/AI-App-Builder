...
export function evaluateGameCreatorReadiness({internalEvidence={},productionEvidence={}}={}){
  ...
  return{
    ...
    truthRule:"A 100 internal Game Creator score proves the implemented creation/runtime/platform/content-production contract only. Production 100 additionally requires verified live networking, matchmaking, load/failover evidence, iOS/Android device evidence and store-release evidence."
  };
}
