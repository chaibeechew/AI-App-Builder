...
export function applyGeneratedQualityBaseline(specification={}){
  ...
  return {
    ...
    designSystem:{
      ...
      layoutSignature:String(design.layoutSignature||"Mobile-first responsive composition with a clear hero, focused primary action, adaptive card/data regions and consistent App + Website navigation."),
      fontDirection:String(design.fontDirection||"Readable modern type system with compact mobile display hierarchy, accessible body sizing and consistent responsive rhythm."),
    },
    qualityPlan:{
      ...qualityPlan,
