...
const TERMS = {
  ...
  beauty: ["visual", "design", "style", "brand", "image", "gallery", "theme", "layout", "hero", "background", "premium", "responsive", "palette", "color"],
...
5. Beauty: original premium visual identity, distinctive layout, memorable hero treatment, refined typography and spacing, high-quality background/imagery direction, polished app-like states and responsive composition. Avoid generic template appearance. Customer color choices must coordinate backgrounds, surfaces, buttons, cards, icons, typography, borders, gradients and imagery treatment as one system.
