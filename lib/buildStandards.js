...
export function assessBuildQuality(specification) {
  ...
  return { overall, passed: dimensions.every((item) => item.passed) && overall >= RELEASE_READINESS_SCORE, dimensions, security, methodology: "deterministic-spec-quality-gate-v6-soolenai-max-security" };
}
