...
export function inferMobileGamePlan(idea=""){
  ...
  const genre=mobaPlan.matched?{id:"moba",label:"MOBA / 5v5 Hero Battler"}:aviationPlan.matched?{id:"air_combat",label:"Air Combat / Flight"}:specialistGenre||GENRES.find(item=>hasAny(source,item.patterns))||{id:"custom",label:"Custom Mobile Game"};
