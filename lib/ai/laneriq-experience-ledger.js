...
export function createExperienceCandidate({domain="architecture",title="",lesson="",source="contract",evidence=[],risk="normal",createdBy="laneriq-system",containsPrivateUserContent=false}={}){
  ...
  return{contract:"laneriq-experience-candidate-v1",id:fingerprint(safe).slice(0,32),status:"candidate",...safe,containsRawSecrets:false,containsPrivateUserContent:false,containsDirectPii:false,autoPromotable:false};
}
