...
export function buildLivingCharacterManifest({characterId,type="profile",style="cinematic",persona,voiceStyle,motionProfile,language="en",continuityKey=""}={}){
  ...
  return{
    ...
    interfaces:{
      ...
      session:{contract:"laneriq-living-avatar-session-v1",voiceFaceRendererOrchestration:true}
    },
    runtime:{
      ...
      localFirst:["idle-motion","blink","gaze","micro-expression","basic-viseme-playback","state-transitions","renderer-lod-selection"],
    ...
    readiness:{
      ...
      proceduralFaceRuntime:true,
      lipSyncContract:true,
      streamingVoiceRuntime:true,
      voiceBargeInRuntime:true,
      adaptiveRendererAdapter:true,
      mobileSurfaceContract:true,
      memoryContract:true,
      agentMemoryBridge:true,
