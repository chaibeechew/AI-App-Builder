...
export function buildCharacterAgentContext({manifest,runtimeState,shortTermContext=[],persistentMemory=[],persistentMemoryOptIn=false}={}){
  ...
  return{
    contract:"laneriq-character-agent-context-v1",
    ...
    instructions:["preserve-character-identity","use-state-aware-responses","do-not-infer-sensitive-personal-attributes","do-not-expose-provider-identities"]
  };
}
