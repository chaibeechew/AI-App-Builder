...
export const NON_PRODUCTION_AREAS = Object.freeze([
  ...
  { key: "gameRuntime", label: "Game Runtime", weight: 4 },
  { key: "integrations", label: "Managed Connections", weight: 4 },
  { key: "monetization", label: "Payments & Offers", weight: 4 },
  { key: "analytics", label: "Analytics & Operations", weight: 4 },
  { key: "exportOwnership", label: "Export & Ownership", weight: 4 },
  { key: "recovery", label: "Recovery & Rollback", weight: 4 },
  { key: "accessibility", label: "Accessibility", weight: 4 },
  { key: "routeResilience", label: "Loading & Error Recovery", weight: 4 },
]);
...
export function evaluateNonProductionReadiness(input = {}) {
  ...
  return {
    ...
    blockers,
    productionHeld: true,
    note: "This score covers product/code readiness across the complete workspace only. Production promotion, live providers, payment execution, store submission and real-device evidence remain intentionally separate.",
  };
}
