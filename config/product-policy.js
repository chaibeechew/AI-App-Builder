export const PRODUCT_POLICY = Object.freeze({
  ...
  promotion: {
    freeFirstProject: {
      ...
      note: "Eligible customers can create one App + Website project, refine it with AI until it fits their needs, and complete the LANERIQ AI publishing workflow without a LANERIQ AI creation charge. Apple/Google developer fees and other third-party charges remain payable directly to those providers. Existing non-game Buyout License rules remain unchanged unless that specific project used the Encourage Creator Program.",
    },
    creatorEncouragementProgram: {
      individualOnly: true,
      extensionMonthsPerApprovedCode: 3,
      allFeaturesDuringApprovedExtension: true,
      buyoutLicenseAvailableForSupportedProject: false,
      buyoutRestrictionScope: "project_that_redeemed_creator_support",
      otherProjectsFollowStandardBuyoutPolicy: true,
      externalMigrationRequiresApprovedRevenueShareAgreement: true,
      revenueSharePercentAfterExternalMigration: 10,
      note: "Only the specific project that actually redeemed Encourage Creator support loses the Buyout License option. Other projects owned by the same Creator continue to follow the normal LANERIQ AI Buyout License policy."
    },
  },
  pricing: {
  ...
  monetization: {
    ...
    gameCommercialization: {
      ...
      note: "LANERIQ AI-generated games are Pro-only and remain owned by the customer. Game projects do not offer a Buyout License. When a generated game is sold commercially, LANERIQ AI receives a continuing 5% share of game sales revenue across every sales channel, including outside LANERIQ AI. The sales-share basis excludes separately stated taxes, refunds and chargebacks; platform/store commissions and the creator's operating costs do not reduce the 5% basis. Production legal terms must define reporting and payment timing clearly before launch."
    },
    referral: {
      enabled: true,
    ...
    buyout: {
      ...
      creatorEncouragementSupportedProjectEligible: false,
      creatorEncouragementRestrictionScope: "supported_project_only",
      unrelatedProjectsOfCreatorRemainEligible: true,
      sourceCodeAccess: {
        enabled: true,
