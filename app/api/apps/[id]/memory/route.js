...
export async function GET(_request,{params}){
  try{
    ...
    return NextResponse.json({success:true,app:{id:app.id,name:app.name},memory:memory?{...memory,memory_json:sanitizeMemoryJson(memory.memory_json)}:null});
...
export async function POST(request,{params}){
  try{
    ...
    return NextResponse.json({success:true,memory:{...data,memory_json:sanitizeMemoryJson(data.memory_json)}});
