...
function publicStatusPayload(truth) {
  return {
    ...
    providerEvidence: truth.providerEvidence,
    ...
    externalProvidersLiveVerified: truth.externalProvidersLiveVerified,
    externalProviderEvidenceLevel: truth.externalProviderEvidenceLevel,
  ...
  try {
    ...
    if (!truthBefore.zeroCostLaunchMode) {
      return json({
        ...
        launchModeLive: false,
        externalProvidersLiveVerified: truthBefore.externalProvidersLiveVerified,
        externalProviderEvidenceLevel: truthBefore.externalProviderEvidenceLevel,
        providerEvidence: truthBefore.providerEvidence,
