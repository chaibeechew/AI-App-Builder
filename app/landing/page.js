    ...
    <main className="landing">
      <header className="nav">
        <div className="brand">
          ...
          <div><strong>AI APP BUILDER</strong><span>Create. Shape. Build.</span></div>
        </div>
      ...
      <section id="demo" className="demo">
        <div className="sectionHead"><div className="eyebrow">ONE IDEA. ONE APP.</div><h2>See what you can build</h2><p>From young creators to experienced business owners, anyone can start with an idea.</p></div>
        <div className="demoGrid">{demos.map((demo)=><div className="demoCard" key={demo.title}><div className="demoIcon">{demo.icon}</div><h3>{demo.title}</h3><p>{demo.text}</p><div className="miniPreview"><span></span><span></span><span></span></div></div>)}</div>
      </section>
