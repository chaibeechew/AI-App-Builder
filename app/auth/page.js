...
// Legacy migration alias retained for non-production compatibility: AI BUILD APP & WEB
  ...
  async function sendCode(event) {
    ...
    try {
      ...
      if (method === "sms") {
        ...
        setIdentifier(email);
        setSent(true);
        setMessage(`LANERIQ AI verification code sent to ${email}. Check your inbox and spam folder.`);
      }
