...
const STORAGE_KEY="ai-build-wallpaper";const SEED_KEY="ai-build-wallpaper-seed";const COOKIE_KEY="ai_build_wallpaper";
...
function homeSurface(){if(typeof window==="undefined")return false;const path=window.location.pathname.toLowerCase();return path==="/"||path==="";}
...
function validChoice(id){return id==="random"||WALLPAPER_PRESETS.some(x=>x.id===id);}
