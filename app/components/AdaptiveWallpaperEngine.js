...
function detectStage(){
  ...
  if(path==="/"||path===""){
    const progress=textOf(".progress");
    ...
    if(textOf(".workspace").includes("live preview"))return"preview";
    return"idea";
  }
