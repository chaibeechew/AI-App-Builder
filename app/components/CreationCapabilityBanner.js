...
export default function CreationCapabilityBanner(){
  ...
  return <section className="creationExpansion" aria-label={`${PRODUCT_BRAND.name} creation capabilities`}>
    <div className="inner">
      <div className="headline"><div><small>{PRODUCT_BRAND.descriptor.toUpperCase()}</small><h2>Create your own <b>App</b>, <b>Game</b> or <b>Website</b>.</h2><p>{PRODUCT_BRAND.tagline} SoolenAI plans, designs, builds, tests and prepares the product foundation—mobile-first, with iOS + Android targets and a fast web preview path.</p></div><div className="platforms"><span>APPS</span><span>GAMES</span><span>WEB</span><span>iOS + Android</span></div></div>
