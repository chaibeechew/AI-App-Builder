...
export default function CreationCapabilityBanner(){
  ...
  return <section className="creationExpansion" aria-label={`${PRODUCT_BRAND.name} creation capabilities`}>
    <div className="inner">
      ...
      <p className="platformNote">Create mobile-first App, Website and Pro Game foundations for iOS &amp; Android, with fast Web Preview before external native release.</p>
