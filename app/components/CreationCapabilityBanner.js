...
export default function CreationCapabilityBanner(){
  ...
  return <section className="creationExpansion" aria-label="AI BUILD APP&WEB creation capabilities">
    <div className="inner">
      <div className="headline"><div><small>ONE IDEA · YOUR OWN PRODUCT</small><h2>Build your own <b>App</b>, <b>Website</b> or <b>Mobile Game</b>.</h2><p>You bring the idea. SoolenAI plans, designs and builds the product foundation—mobile-first, with iOS + Android targets for mobile apps and games, plus a fast web preview path.</p></div><div className="platforms"><span>iOS</span><span>Android</span><span>Web</span><span>Mobile Game · PRO</span></div></div>
      ...
      <div className="gameCallout"><div><small>SOOLENAI PRO GAME CREATOR · FAIR PRICE · FAIR USE</small><strong>From “I have a game idea” to a playable 2D Vertical Slice.</strong><span>Scene · touch controls · physics/collision · player/enemy · levels · score/health · save/load · audio · pause/restart · iOS/Android readiness. 3D and Multiplayer are the upgrade path.</span></div><Link href="/game-builder">Create a Game ›</Link></div>
    </div>
