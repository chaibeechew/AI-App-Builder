...
export default function AccountNav() {
  ...
  return (
    <div className="accountNav">
      <Link href="/my-apps" className="appFolderButton">📁 App Folder</Link>
      ...
      <style jsx>{`
        ...
        @media(max-width:720px){.accountNav{right:10px;left:10px;top:10px;justify-content:flex-end;flex-wrap:wrap}.accountNav a,.accountNav button{font-size:11px;padding:7px 8px}}
      `}</style>
    </div>
  );
}
