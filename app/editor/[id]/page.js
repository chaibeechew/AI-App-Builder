...
export default function AppEditor({ params }) {
  ...
  async function modify(text = instruction) {
    ...
    try {
      ...
      setMessage(`Done — saved as version ${data.version?.version_no || "new"}. You can undo it from Version History.`);
      await loadApp();
