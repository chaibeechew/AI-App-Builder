...
export default function GameE2ELab(){
  ...
  return <main style={styles.shell}><div style={styles.wrap}>
    ...
    <section style={styles.box}><b style={{color:"#e2c566"}}>Truth boundary</b><p style={styles.small}>{suite.truthRule}</p><p style={styles.small}>Next external smoke layer: one controlled Preview generation through an actually connected AI provider, followed by browser/device evidence. It stays separate so zero-cost CI remains deterministic and repeatable.</p></section>
  </div></main>;
}
