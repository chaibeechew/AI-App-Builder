...
for(const path of ["/","/auth","/api/templates?mode=meta","/api/soolenai/capabilities","/api/apps","/mobile-readiness","/robots.txt","/sitemap.xml","/ai-app-game-website-builder"]){
...
console.log("✓ Production surface code keeps SEO/capability/mobile diagnostics public while private customer routes remain authenticated");
