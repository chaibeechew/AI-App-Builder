...
assert.ok(replayCheck>0&&financeStart>0&&aiStart>0&&replayCheck<financeStart&&replayCheck<aiStart,'Replay lookup must happen before finance and AI execution.');
