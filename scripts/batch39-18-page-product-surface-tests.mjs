...
assert.equal(LANERIQ_18_PAGE_DESIGN_RULES.legacyBigMoonValleyActive,false);
...
console.log('✓ Big Moon is explicitly retired from the active master design rules');
