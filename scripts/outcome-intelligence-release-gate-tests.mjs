...
const base={
  name:'Outcome Intelligence Candidate',description:'Original workflow candidate',
  designSystem:{visualDirection:'premium original editorial interface',backgroundDirection:'layered responsive background',heroDirection:'intent-first living hero',layoutSignature:'adaptive bento workspace',fontDirection:'humanist responsive sans',iconStyle:'semantic icons',themeMode:'auto',colorPreference:'accessible coordinated palette',paletteRationale:'high contrast',cardStyle:'living cards',imageStyle:'original editorial imagery',wallpaperPreset:'moon-city',motionDirection:'semantic reduced-motion-safe motion'},
  qualityPlan,
  pages:[
    {name:'Home',route:'/',purpose:'Intent and next actions',components:[{type:'hero'},{type:'command'}]},
    {name:'Workspace',route:'/workspace',purpose:'Core work queue',components:[{type:'kanban'},{type:'filter'}]},
    {name:'Calendar',route:'/calendar',purpose:'Schedule and follow up',components:[{type:'calendar'},{type:'timeline'}]},
    {name:'Insights',route:'/insights',purpose:'Understand progress',components:[{type:'chart'},{type:'card'}]},
    {name:'People',route:'/people',purpose:'Manage relationships',components:[{type:'search'},{type:'list'}]},
    {name:'Settings',route:'/settings',purpose:'Control preferences',components:[{type:'tabs'},{type:'form'}]},
  ],
  features:[{name:'Search',description:'Search with loading empty error retry recovery'},{name:'Workflow',description:'Role-aware mobile workflow'},{name:'Insights',description:'Accessible responsive analytics'},{name:'Recovery',description:'Offline weak-network reconnect and retry'}],
  actions:[{name:'Search',intent:'search'},{name:'Create',intent:'create'},{name:'Book',intent:'book'},{name:'Message',intent:'message'},{name:'Share',intent:'share'}],
  navigation:[{label:'Home',route:'/'},{label:'Workspace',route:'/workspace'},{label:'Calendar',route:'/calendar'},{label:'Insights',route:'/insights'},{label:'People',route:'/people'},{label:'Settings',route:'/settings'}],
...
const pool=evaluateGenerationCandidatePool([
  {id:'weak',provider:'remote',sourceKind:'primary-provider',specification:weak},
  {id:'strong',provider:'laneriq-local-transform',sourceKind:'zero-cost-structural-shadow',specification:strong},
  {id:'duplicate-weak',provider:'laneriq-local-transform',sourceKind:'zero-cost-structural-shadow',specification:weak},
]);
