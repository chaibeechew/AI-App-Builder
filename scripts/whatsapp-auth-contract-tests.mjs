...
assert.match(authPage, /verifyWhatsAppCompatibility\(\{ phone: normalizePhoneNumber\(identifier\), token \}\)/);
...
const whatsappVerifyIndex=authPage.indexOf('await verifyWhatsAppCompatibility({ phone: normalizePhoneNumber(identifier), token })');
