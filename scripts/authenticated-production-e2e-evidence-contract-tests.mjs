...
for (const pattern of [
  ...
  /providerOutputReplayed:\s*false/,
...
console.log("✓ Fresh Generate→Save evidence is bounded to a project created within 20 minutes instead of inferred from an old project");
