...
const checks=[
  ...
  ['Database is no-code and rejects credential-like fields',
    has('app/api/apps/[id]/database/route.js','SAFE_TYPES','SECRET_FIELD','_history')&&
    has('app/database/[id]/page.js','Database Builder','without exposing infrastructure secrets','/database/rollback','previous version is kept so you can undo safely','Restore')],
