...
assert.ok(generate.indexOf('adult.generationStatus!=="verified"')<generate.indexOf('persistBuilderGeneratedProject'),"Unverified generation must never cross the Cloud persistence boundary.");
