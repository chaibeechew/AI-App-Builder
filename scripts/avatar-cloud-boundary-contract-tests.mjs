...
console.log('Avatar Cloud boundary passed: App routes stay provider-opaque while authenticated owner-scoped persistence remains isolated behind the compatibility adapter.');
