...
const cases = [
  ...
  () => assert.equal(CREATE_APP_FLOW.stages.includes("create"), false),
  ...
  () => assert.equal(USER_FEATURE_CONTROLS.imageInput.userControlled, true),
  () => assert.equal(USER_FEATURE_CONTROLS.handDrawnSketch.userControlled, true),
  () => assert.equal(USER_FEATURE_CONTROLS.documentUpload.userControlled, true),
  () => assert.equal(USER_FEATURE_CONTROLS.chatMode.userControlled, true),
  () => assert.equal(USER_FEATURE_CONTROLS.voiceOutput.userControlled, true),
  () => assert.equal(USER_FEATURE_CONTROLS.notifications.userControlled, true),
  () => assert.equal(USER_FEATURE_CONTROLS.accessibility.userControlled, true),
  () => assert.equal(PUBLISH_APPLICATION_ASSISTANT.finalSubmission.customerReviewRequired, true),
  () => assert.equal(PUBLISH_APPLICATION_ASSISTANT.finalSubmission.customerConfirmationRequired, true),
];
